      ...
      <Mtitle
        ...
        rightcontent={
          <div className='flex justify-between mt-4 md:mt-0'>
            <div className="flex justify-end gap-2 md:gap-3 items-center mb-4">
              ...
              <div className="flex cursor-pointer items-center bg-yellow-500 text-white py-2 px-2 rounded-xl shadow hover:bg-yellow-600 transition duration-300">
      ...
      {loading ? (
        ...
        <div className="flex  flex-row-reverse  mb-7">
          ...
          <div className='flex  w-full space-x-2 md:space-x-4'>
            <div className=''>
              <h3 className="font-medium md:text-lg  border  p-2 md:pr-5 rounded-xl flex min-w-max items-center gap-3"><span><IoFilterOutline></IoFilterOutline></span> Filter Lockers</h3>
            </div>
            <select
              value={gender}
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-2 md:gap-4">
          ...
          >
            <p><PiLockKeyLight className='text-2xl md:text-4xl mt-1' /></p>
