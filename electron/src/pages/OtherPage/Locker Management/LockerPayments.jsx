      ...
      {loading ? (
        ...
        <>
          <Mtitle
            ...
            rightcontent={
              <div className='flex mt-3 md:mt-0 justify-between'>
                <div className="flex justify-center md:justify-end gap-2 md:gap-4 items-center md:mb-4">
                  ...
                  <div className="flex gap-2 cursor-pointer items-center bg-yellow-500 text-white p-2 md:py-2 md:px-4 rounded-xl shadow hover:bg-yellow-600 transition duration-300">
          ...
          <div className="md:p-4 px-2">
            <div className='flex  flex-row-reverse md:mb-3'>
              <div className='w-full'></div>
              <div className="flex w-full space-x-3 md:space-x-4 mb-4">
                <div className=''>
                  <h3 className="font-medium md:text-lg  border  p-2 pr-5 rounded-xl flex min-w-max items-center gap-3"><span><IoFilterOutline /></span> Filter Lockers</h3>
                </div>
                <select
                  value={gender}
