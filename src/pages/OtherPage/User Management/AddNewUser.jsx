    ...
    try {
      ...
      if (error?.response?.status === 400) {
        Swal.fire({
          icon: "error",
          title: "Login Error",
          text: errorMessage || "Please check back and try again later.",
        });
        ...
        if (errorMessage.includes("email") && errorMessage.includes("mobile")) {
          ...
          Swal.fire({
            ...
            text: "Both email and mobile number already exist.",
          });
    ...
    >
      <form className="px-5 py-3" onSubmit={handleSubmit(onSubmit)}>
        <div className="md:grid md:grid-cols-2 gap-3 ">
          <p className="text-xl col-span-2 bg-gray-600 text-white px-4  py-2 rounded-xl font-medium ">
            Subscription Form
          </p>
          <MemberRegisterInput
            type={"text"}
