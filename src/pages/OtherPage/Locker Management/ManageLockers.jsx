...
const ManageLockers = () => {
  ...
  return (
    <div className='px-4 md:px-2'>
      <Mtitle
        ...
        rightcontent={
          <div className='flex mt-3 md:mt-0 justify-between'>
            <div className="flex justify-end gap-3 md:gap-4 items-center md:mb-4">
              ...
              <div className="flex md:gap-2 cursor-pointer items-center bg-yellow-500 text-white md:py-2 p-3 md:px-4 rounded-xl shadow hover:bg-yellow-600 transition duration-300">
                <button onClick={handleAddNew} className="font-semibold hidden md:block">Add New</button>
      ...
      <div className="text-sm mb-2 text-gray-500 md:mb-0 md:text-base">
      ...
      <div className="md:mt-5 mt-3">
        <div className=' flex flex-row-reverse'>
          ...
          <div className="flex space-x-3 md:space-x-4 w-full">
            <div className=''>
              <h3 className="font-medium md:text-lg  border  p-2 pr-5 rounded-xl flex min-w-max items-center gap-3"><span><IoFilterOutline></IoFilterOutline></span> Filter Lockers</h3>
            </div>
            <select
              value={group}
              onChange={(e) => setGroup(e.target.value)}
              className="focus:border-gray-300 appearance-none cursor-pointer text-gray-700  border shadow-sm rounded-xl w-full md:py-3 px-3 leading-tight focus:outline-none focus:shadow-outline"
            >
