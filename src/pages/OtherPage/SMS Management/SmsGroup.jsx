                                ...
                                paginatedData.map((group) => (
                                    <tr key={group._id} className="hover:bg-slate-100 rounded-xl text-sm md:text-base transition duration-200 ease-in-out">
                                        <td className="px-4 py-3 flex items-center">
                                            <span
                                                className={`w-3 h-3 rounded-full mr-2 ${group.status === "active" ? "bg-green-500" : "bg-red-500"
                                                    }`}
                                            ></span>
                                            {group.groupName}
                                        </td>
                                        ...
                                        <td
                                            className={`px-4 font-bold py-3 ${group.status === "active" ? "text-green-500" : "text-red-500"
                                                }`}
                                        >
