...
const GroupModal = ({ isOpen, onClose, onSubmit,loading, initialData, branch }) => {
            ...
            <div className="modal-box">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="modal-action">
                        ...
                        <button disabled={loading} type="submit" className="bg-yellow-500 text-white py-2 px-4 font-semibold flex  items-center gap-2 hover:bg-yellow-700 rounded-xl transition duration-300">
                            {
                                loading && 
