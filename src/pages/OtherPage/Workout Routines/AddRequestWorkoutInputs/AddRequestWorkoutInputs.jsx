...
import EditRequestWorkoutQuestion from "./Forms/EditRequestWorkoutQuestion";
import RequestWorkoutQuestion from "./Forms/RequestWorkoutQuestion";
import { useAuth } from "../../../../providers/AuthProvider";

function AddRequestWorkoutInputs() {
  ...
  useEffect(() => {
    const fetchPaymentMethodData = async () => {
      try {
        const response = await axiosSecure.get(`/workout-routines/workout-habit-question/get?branch=${branch}`);
    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          const response = await axiosSecure.delete(`/workout-routines/workout-habit-question/delete/${id}`);
  ...
  return (
    <div className="px-3">
      <div className="pl-2">
        <Mtitle
          title="Add Workout Question Input"
          rightcontent={
            <div
                ...
                <tr>
                  <td colSpan="4" className="text-center h-96">
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">No Data found with this search criteria.</p>
                    </div>
                  </td>
                </tr>
              )}
...
export default AddRequestWorkoutInputs;
