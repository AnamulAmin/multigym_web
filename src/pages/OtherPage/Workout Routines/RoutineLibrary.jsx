...
const EditModal = ({ routine, loading, setRoutine, handleEditSubmit, closeModal }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
      ...
      >
        ...
        <div className="px-6 py-4 flex justify-end">
          ...
          <button
            type="submit"
            className="bg-yellow-500 flex justify-center items-center gap-3 hover:bg-yellow-600  text-white px-4 py-2 rounded-xl font-semibold"
            disabled={loading}
          >
            {loading && (
