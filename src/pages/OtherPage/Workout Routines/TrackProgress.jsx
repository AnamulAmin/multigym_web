  ...
  const memberData = [
    {
      ...
      goal: "80 kg",
      progress: 75,
      numberOfDaysWorkout: 3,
      followsRoutine: "Yes",
      calorieBurn: "500 kcal/day",
    ...
    },
    {
      ...
      goal: "65 kg",
      progress: 60,
      numberOfDaysWorkout: 4,
      followsRoutine: "No",
      calorieBurn: "450 kcal/day",
    ...
    },
    {
      ...
      goal: "85 kg",
      progress: 50,
      numberOfDaysWorkout: 5,
      followsRoutine: "Yes",
      calorieBurn: "600 kcal/day",
    ...
    },
    {
      ...
      goal: "60 kg",
      progress: 45,
      numberOfDaysWorkout: 2,
      followsRoutine: "No",
      calorieBurn: "350 kcal/day",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {displayedMembers.map((member) => (
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
              <span className="font-semibold">Days Workout/Week:</span> {member.numberOfDaysWorkout}
            </p>
            <p className="mt-1 text-sm text-gray-600">
              <span className="font-semibold">Routine Followed:</span> {member.followsRoutine}
            </p>
            <p className="mt-1 text-sm text-gray-600">
              <span className="font-semibold">Calories Burned:</span> {member.calorieBurn}
            </p>
            <div className="mt-3">
