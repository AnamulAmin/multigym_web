  ...
  return (
    <div className="p-4">
      ...
      <Mtitle
        ...
        rightcontent={
          <section className="flex mt-4 md:mt-0 justify-between">
            <div className="flex justify-end gap-4 items-center md:mb-4">
              ...
              {/* Add new button */}
              <div className="flex md:gap-2 cursor-pointer text-sm md:text-base items-center bg-yellow-500 text-white px-2 py-2 md:px-4 rounded-xl shadow hover:bg-yellow-600 transition duration-300">
                <button onClick={openModal} className="font-semibold min-w-max">
                  New Class
                </button>
            ...
            <tbody>
              {paginatedData.map((item, index) => (
                <tr key={index} className="hover:bg-slate-100 hover:rounded-xl">
                  ...
                  <td className="flex gap-3 text-base my-5">
                    <button
      ...
      <Mmodal isOpen={isOpen} onClose={closeModal}>
        ...
        <form onSubmit={handleSubmit} className="grid gap-5">
          <div className="flex md:flex-row flex-col gap-4">
            <div className="w-full">
              ...
              <input
                ...
                className="focus:border-yellow-500 appearance-none text-gray-700 text-sm border shadow-sm rounded-xl w-full  py-2 md:py-3 px-3 leading-tight focus:outline-none focus:shadow-outline"
              />
            </div>
            <div className="w-full">
              <label className="block mb-1 text-sm font-medium text-gray-700">
          ...
          <div className="mt-4 flex justify-end">
            <button
              type="submit"
              className="bg-yellow-500 text-white py-2 px-4 flex justify-center items-center gap-3 font-semibold hover:bg-yellow-600 rounded-xl transition duration-300"
              disabled={btnLoading}
            >
              {btnLoading && (
