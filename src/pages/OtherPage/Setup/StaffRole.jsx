...
import MsearchBox from "../../../components library/MsearchBox";
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="flex justify-end space-x-4">
              ...
              <button
                ...
                className="bg-yellow-500 text-white flex justify-center items-center gap-3 py-2 px-4 rounded-lg hover:bg-yellow-700 transition duration-150"
              >
                {
                  loading &&
